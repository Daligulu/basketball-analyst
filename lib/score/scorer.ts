import { DEFAULT_CONFIG, type CoachConfig, type WeightBucket, type ScoreRule as CoachScoreRule } from '../../config/coach'

export type ScoreItem = { key:string; label:string; score:number; value?:number; unit?:string }
export type Bucket   = { name:string; score:number; items: ScoreItem[] }
export type ScoreResult = { total:number; buckets: Bucket[] }
